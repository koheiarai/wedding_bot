...
// event.message.id should be filled here to get the Image content 
...
// ToDo: Write the function to get an image
// function getContent(messageId) {
//   // let options = require(templatePath + 'GET_CONTENT.json'); ToDo: a_change
//   let options = JSON.parse(fs.readFileSync(templatePath + 'GET_CONTENT.json', 'UTF-8'));
//   const data = {
//     'url': this.config['BASE_URL'] + this.config['GET_CONTENT_PATH_FIRST'] + "/" + messageId + "/" + this.config['GET_CONTENT_PATH_SECOND'],
//     'headers': {
